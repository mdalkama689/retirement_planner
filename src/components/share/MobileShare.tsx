...
const MobileShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "I found this useful retirement saving calculator tool, check it out: https://seosaurus.in/tools/retirement-savings-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/retirement-savings-calculator/";
  const handleClick = () => {
